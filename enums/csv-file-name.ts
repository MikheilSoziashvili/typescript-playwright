export enum CsvFilesName {
	...
	LOGIN_INPUT_VALIDATION = "ENG-9836-login-input-validation.csv",
	LOGIN_REJECTED = "ENG-9836-login-rejected.csv",
	LOGIN_SUCCESSFUL = "ENG-7849-login-successful.csv",
	...
	CHANGE_PASSWORD_2FA = "ENG-11753-change-password-2fa.csv",
