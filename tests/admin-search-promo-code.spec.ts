...
test.describe("Search for Promo codes", () => {
    ...
    test("[ENG-6184] Search for existing promo code in the campaigns table", async ({
        promoCampaignsAdminPage,
    }) => {
    ...
    test("[ENG-6184] Search for non-existing promo code in the campaigns table", async ({
        promoCampaignsAdminPage,
        toast,
    }) => {
