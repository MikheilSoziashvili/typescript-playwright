...
test.describe(
	...
	() => {
		...
		test(`[ENG-7179] Custom rewards - reload`, async ({
			gamdomApi,
			gamdomDb,
			browser,
			userInfoAdminPage,
		...
		test(`[ENG-7179] Custom rewards - vip`, async ({
			gamdomApi,
			gamdomDb,
			browser,
			userInfoAdminPage,
		...
		test(`[ENG-7179] Custom rewards - vip - cancel`, async ({
			gamdomDb,
			userInfoAdminPage,
			userInfoRewardsAdminPage,
			userInfoRewardsHistoryAdminPage,
		...
		test(`[ENG-7179] Custom rewards - xp challenge`, async ({
			gamdomApi,
			gamdomDb,
			browser,
			userInfoAdminPage,
		...
		test(`[ENG-7179] Custom rewards - xp challenge - cancel`, async ({
			gamdomDb,
			userInfoAdminPage,
			userInfoRewardsAdminPage,
			userInfoRewardsHistoryAdminPage,
		...
		test(`[ENG-7179] Custom rewards - kyc verification`, async ({
			gamdomApi,
			gamdomDb,
			browser,
			userInfoAdminPage,
		...
		test(`[ENG-7179] Custom rewards - kyc verification - cancel`, async ({
			gamdomDb,
			userInfoAdminPage,
			userInfoRewardsAdminPage,
			userInfoRewardsHistoryAdminPage,
...
test.describe(
	...
	() => {
		...
		test(`[ENG-7179] Rewards history - Promo code - cash`, async ({
			gamdomApi,
			gamdomDb,
			browser,
			userInfoAdminPage,
		...
		test(`[ENG-7179] Rewards history - Promo code - free spins`, async ({
			gamdomApi,
			gamdomDb,
			browser,
			userInfoAdminPage,
...
test.describe(
	...
	() => {
		...
		tipTypes.forEach(({ tipType, rewardType }) => {
			test(`[ENG-7179] Rewards history - Tip - ${tipType}`, async ({
				infoAdminPage,
				userInfoAdminPage,
				userInfoRewardsHistoryAdminPage,
				toast,
				...
				await infoAdminPage
					.steps()
					.tipUserWith2FaFlow(tipAmount, qrCode2FAImagePath, tipType);
...
test.describe(
	...
	() => {
		...
		test(`[ENG-7179] Rewards history - Royalty up and instant`, async ({
			gamdomApi,
			gamdomDb,
			browser,
			userInfoAdminPage,
		...
		test(`[ENG-7179] Rewards history - Royalty up and instant - cancel`, async ({
			gamdomApi,
			gamdomDb,
			browser,
			userInfoAdminPage,
...
test.describe(
	...
	() => {
		...
		test(`[ENG-7179] Rewards history - Weekly reward`, async ({
			gamdomApi,
			gamdomDb,
			browser,
			userInfoAdminPage,
			...
			await rewardsPage.assertThat().weeklyRewardIsVisibleAndAvailable();
		...
		test(`[ENG-7179] Rewards history - Monthly reward`, async ({
			gamdomApi,
			gamdomDb,
			browser,
			userInfoAdminPage,
			...
			await rewardsPage.assertThat().monthlyRewardIsVisibleAndAvailable();
